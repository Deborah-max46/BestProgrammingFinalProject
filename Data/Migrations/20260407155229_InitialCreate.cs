        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssignedAdvocateId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Complaints_AspNetUsers_AssignedAdvocateId",
                        column: x => x.AssignedAdvocateId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Complaints_AspNetUsers_ConsumerId",
                        column: x => x.ConsumerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Complaints_Businesses_BusinessId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ComplaintMessages_AspNetUsers_AuthorUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ComplaintMessages_AuthorUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Complaints_AssignedAdvocateId",
                table: "Complaints",
                column: "AssignedAdvocateId");
